...
('root', '[{\"db\":\"waterfood\",\"table\":\"admin\"},{\"db\":\"waterfood\",\"table\":\"food\"}]');
...
('root', '2023-12-18 22:54:50', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"zh_TW\"}');
...
-- 資料庫： `waterfood`
--
CREATE DATABASE IF NOT EXISTS `waterfood` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `waterfood`;
...
CREATE TABLE `food` (
  ...
  `flist` int(11) NOT NULL COMMENT '訂單編號',
...
(1, 222, '2023-12-18 13:18:59', '097777777', '百香果', '500'),
(7, 2147483647, '2023-12-18 22:56:18', '2121212', '11', '5500');
...
--
ALTER TABLE `food`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '編號', AUTO_INCREMENT=8;
COMMIT;
